#include<stdio.h>
int runningpay , basicsalary,experience,perincrement_amount,age,donation,grosspay,donation;
 char grade ;

void basicpay();
void allowence();         //variable decleration
void deduction();
...
void deduction()
{
   int IT,AI,GPF,Total_deduction,Net_pay;
